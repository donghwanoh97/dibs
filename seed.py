...
print(
    f"{len(user_result.inserted_ids)}명의 유저 더미 데이터를 "
    "성공적으로 삽입했습니다."
)
...
posts = [
    ...
    # ------------------------------------------------------------
    # ⭐ 가장 위에 보여줄 모임
    # 참여인원 1/2 → 내가 참여하면 2/2 → 마감
    # ------------------------------------------------------------

    {
        "title": "오늘 저녁 삼겹살 같이 드실 분",
        "date": "2026-08-28",
        "time": "18:30",
        "joined_users": [
            user_map["chulsoo"]
        ...
        "category": "meal",
        "content": "수업 끝나고 학교 근처에서 삼겹살 먹으려고 해요. 한 자리 남았는데 같이 드실 분!",
        "created_at": "2026-08-27T05:59:00.000Z",
    },
...

    {
        ...
        "author": user_map["younghee"],
        "category": "meal",
        "content": "점심시간에 학교 근처 돈까스집 가려고 합니다. 혼밥하기 아쉬워서 같이 드실 분 찾아요!",
        "created_at": "2026-08-27T05:20:00.000Z",
    },

    {
        "title": "퇴근 후 치킨 먹고 가실 분 🍗",
        "date": "2026-08-29",
        "time": "19:00",
        "joined_users": [
            user_map["chulsoo"],
        ...
        "category": "meal",
        "content": "이번 주도 고생한 기념으로 치킨 먹으려고 합니다. 편하게 이야기하면서 드실 분 환영해요!",
        "created_at": "2026-08-27T04:40:00.000Z",
    },

    {
        "title": "주말 점심 파스타 맛집 같이 가요 🍝",
        "date": "2026-08-30",
        "time": "12:00",
        "joined_users": [
            user_map["minsu"],
        ...
        "category": "meal",
        "content": "주말에 새로 생긴 파스타집 가보려고 합니다. 맛있는 거 좋아하시는 분 같이 가요!",
...

    {
        ...
        "category": "study",
        "content": "백준이나 프로그래머스 문제를 각자 풀고 풀이를 공유하는 방식으로 진행합니다.",
...

    {
        ...
        "created_at": "2026-08-27T01:50:00.000Z",
    },

    {
        ...
        "author": user_map["chulsoo"],
        "category": "study",
        "content": "취업 준비하면서 서로 정보도 공유하고 모의 면접과 코드 리뷰도 같이 진행해보려고 합니다.",
...

    {
        ...
        "created_at": "2026-08-26T07:40:00.000Z",
    },
...

    {
        ...
        "created_at": "2026-08-26T06:50:00.000Z",
    },
